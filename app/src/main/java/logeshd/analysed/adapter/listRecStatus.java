...
public class listRecStatus extends ArrayAdapter<recStatusDetails> {
    public listRecStatus(Context context, ArrayList<recStatusDetails> history) {
        super(context, 0, history);
    }

    public View getView(int position, View convertView, ViewGroup parent) {
        recStatusDetails p = (recStatusDetails) getItem(position);
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.list_rec_status, parent, false);
        }
