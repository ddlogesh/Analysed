...
public class listShareProfile extends ArrayAdapter<databaseDetails> {
    public listShareProfile(Context context, ArrayList<databaseDetails> history) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.list_share_profile, parent, false);
        }
