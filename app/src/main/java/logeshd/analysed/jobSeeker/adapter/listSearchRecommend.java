...
public class listSearchRecommend extends ArrayAdapter<drawer> {
    public listSearchRecommend(Context context, ArrayList<drawer> history) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.j_list_search_recommend, parent, false);
        }
