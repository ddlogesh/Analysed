...
import logeshd.analysed.adapter.listDatabase;
...
public class myDatabase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.clear();
        adapter.add(new databaseDetails("sample_image", "Logesh D", "App Developer", "url"));
        adapter.add(new databaseDetails("sample_image", "Sagar G", "UI/UX Designer", "url"));
        adapter.add(new databaseDetails("sample_image", "Kiran", "Php Developer", "url"));
