...
public class viewTasksStatus extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.r_view_tasks_status);
        ...
        adapter.add(new recStatus(true,"Task2", "Desc2",-1));
        //adapter.add(new recStatus(false,70));
        adapter.add(new recStatus(true,"Task3", "Desc3",0));
